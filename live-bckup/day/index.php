                                            ...
                                            <ul>
                                                ...
                                                <script>
                                                    ...
                                                    if (current_date === '<?= $_SERVER["QUERY_STRING"] ?>') {
                                                        ...
                                                        $('#date<?php echo $sn . $snEv ?>').attr('style', 'background: rgb(115 115 115 / ' + percentage + '%);');
                                                    }
                        ...
                        <h4>
                            ...
                            <span class="name">
                                ...
                                if (!empty($current_event['link'])) { ?>
                                    <a href="<?php echo $_SERVER["REQUEST_SCHEME"] . "://" . $_SERVER["HTTP_HOST"] ?>/event-detail?<?php echo $current_event['link']; ?>"
                                        class="a-style">
