...
// echo "</pre>";
                                ...
                                <li class="venues">📍
                                    ...
                                    if (isset($value->venues)) {
                                        ...
                                        foreach ($value->venues as $key => $val) {
                                            ?>
                                            <a
                                                href=" <?php echo $_SERVER["REQUEST_SCHEME"] . "://" . $_SERVER["HTTP_HOST"] ?>/place?<?php echo $val ?> ">
                                                <?php
                                                echo ($key != 0) ? ', ' . $val : $val;
                                                ?>
                                            </a>
                        ...
                        <div>
                            <ul>
                                ...
                                if ($value->links->twitter != null && $value->links->twitter != "") {
                                    ...
                                    <li class="Poc">
                                        <span>Twitter:</span>
                                        <span><a target="blank" href="<?php echo $value->links->twitter; ?>"><?php
                                ...
                                if ($value->links->telegram != null && $value->links->telegram != "") {
                                    ...
                                    <li class="Poc">
                                        <span>Telegram:</span>
                                        <span><a target="blank" href="<?php echo $value->links->telegram; ?>"><?php
                            ...
                            <ul>
                                ...
                                if ($value->links->discord != null && $value->links->discord != "") {
                                    ...
                                    <li class="Poc">
                                        ...
                                        ?>
                                        <span>discord:</span>
                                        <span><a target="blank" href="<?php echo $value->links->discord; ?>"><?php
                                           echo substr($value->links->discord, $string_firstpos) ?></a></span>
                                    </li>
                                <?php } ?>
                            </ul>
                        </div>
                ...
                <div class="evnt-content">
                    <p>
                        ...
                        // $https_starting_index = url_strpos_all($modifyfirststr, "https"," ");
                                ...
                                <h4>
                                    ...
                                    <span>
                                        ...
                                        if (isset($segment_value->link)) { ?>
                                            <a href="<?php echo $_SERVER["REQUEST_SCHEME"] . "://" . $_SERVER["HTTP_HOST"] ?>/event-detail?<?php echo $segment_value->link; ?>"
                                                class="a-style">
